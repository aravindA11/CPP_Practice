...
list—for the following program tasks? Explain the rationale for your
choice. If there is no reason to prefer one or another container, explain
why not.
...
Ans:
(a) we can prefer list here as insertion in between is easier
(b) deque: as insertion and deletion happens at ends
(c) vector: sorting happens faster